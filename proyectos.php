...
<h1 align="center" style="font-family:cursive">Proyectos</h1>
<!-- lightbox -->
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="mySlides">
                                   ...
                                   <div class="mySlides">
                                    ...
                                    <img src="img/sizif.png" style="width:70%">
                                  </div>

                                  <div class="mySlides">
                                    <div class="numbertext">6 / 8</div>
                                    <img src="img/sizif2.png" style="width:70%">
                                  </div>

                                  <div class="mySlides">
                                    <div class="numbertext">7 / 8</div>
                                    <img src="img/sizif3.png" style="width:70%">
                                  </div>

                                  <div class="mySlides">
                                    <div class="numbertext">8 / 8</div>
                                    <img src="img/sizif4.png" style="width:70%">
                                  </div>
...
<div class="row" align="center">
  ...
  <div class="col-md-6 col-xs-12">
                    ...
                    <div class="row">
                              ...
                              <div class="column imagresponsive">
                                <img src="img/sizif14.png" onclick="openModal();currentSlide(7)" class="hover-shadow">
                              </div>
                              <div class="column imagresponsive">
                                <img src="img/sizif13.png" onclick="openModal();currentSlide(8)" class="hover-shadow">
                              </div>
                    </div>
