...
<h1 align="center" style="font-family:cursive">Durlock</h1>
<!-- lightbox -->
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="mySlides">
                                   ...
                                   <div class="mySlides">
                                    ...
                                    <img src="img/isam4.png" style="width:50%">
                                  </div>

                                  <div class="mySlides">
                                    <div class="numbertext">6 / 8</div>
                                    <img src="img/isam2.png" style="width:50%">
                                  </div>

                                  <div class="mySlides">
                                    <div class="numbertext">7 / 8</div>
                                    <img src="img/isam3.png" style="width:50%">
                                  </div>

                                  <div class="mySlides">
                                    <div class="numbertext">8 / 8</div>
                                    <img src="img/isam1.png" style="width:50%">
                                  </div>
                                  ...
                                  <div class="column">
                                    <img class="demo" src="img/isam4.png" onclick="currentSlide(5)" >
                                  </div>

                                  <div class="column">
                                    <img class="demo" src="img/isam2.png" onclick="currentSlide(6)">
                                  </div>

                                  <div class="column">
                                    <img class="demo" src="img/isam3.png" onclick="currentSlide(7)" >
                                  </div>

                                  <div class="column">
                                    <img class="demo" src="img/isam1.png" onclick="currentSlide(8)" >
                                  </div>
                              </div>
                              </div>
</div>
...
<div class="row" align="center">
              <div class="col-md-6 col-xs-12 " align="center">
                                     <div class="bordesempresas margcategorias">
                                            <a href="https://www.facebook.com/people/Zita-Marmolesygranitos/100015459668029" target="_blank" >
                                              <h2>Empresa:ACÚSTICA ARQUITECTÓNICA  </h2>
                                            </a>
                                            <div align="left">
                                                  <h3>Categoria:</h3>Durlock- Acustica <br>
                                                  <h4>Descripcion:</h4>En nuestra web encontrará información acerca de desarrollos de proyectos y los pasos seguidos para integración de sistemas, el diseño acústico y la calibración acústica.


                                                  <h3>Contacto</h3> 
                                                  Pagina: <a href="https://http://www.insam.com.ar" target="_blank" >INSAM</a> <br>
                                                  Telefono: 154140-3504<br>
                                                  Correo: info@insam.com.ar <br>
                                                  Correo: <a href="" target="_blank" >info@insam.com.ar</a> <br>
  ...
  <div class="col-md-6 col-xs-12">
                    ...
                    <div class="row">
                              <div class="column imagresponsive">
                                <img src="img/isam4.png" onclick="openModal();currentSlide(5)" class="hover-shadow">
                              </div>
                              <div class="column imagresponsive">
                                <img src="img/isam2.png" onclick="openModal();currentSlide(6)" class="hover-shadow">
                              </div>
                              <div class="column imagresponsive">
                                <img src="img/isam3.png" onclick="openModal();currentSlide(7)" class="hover-shadow">
                              </div>
                              <div class="column imagresponsive">
                                <img src="img/isam1.png" onclick="openModal();currentSlide(8)" class="hover-shadow">
                              </div>
                    </div>
